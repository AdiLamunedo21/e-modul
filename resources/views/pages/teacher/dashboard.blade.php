...
<div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5 mb-8">
    ...
    <div class="rounded-2xl bg-white p-5 border border-slate-200/80 shadow-sm hover:shadow-md transition-shadow">
        ...
        <div class="mt-4 flex items-baseline gap-2">
            ...
            <span class="text-xs font-semibold text-emerald-600">Tuntas Nilai</span>
        </div>
        ...
        <div class="p-5 rounded-2xl border border-slate-200/70 hover:border-blue-300 hover:bg-blue-50/20 transition-all">
            <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
                ...
                <div class="flex items-center gap-2 lg:flex-col lg:items-end shrink-0">
                    ...
                    <a href="{{ route('teacher.reports.index') }}" class="inline-flex items-center gap-1.5 px-3 py-1.5 text-xs font-semibold text-slate-700 bg-white border border-slate-200 hover:bg-slate-50 hover:text-emerald-700 rounded-xl transition-all">
        ...
        <div class="relative z-10">
            ...
            <ul class="mt-4 space-y-2 text-xs text-blue-50">
                ...
                <li class="flex items-start gap-2">
                    ...
                    <span><strong>Bagian Akhir:</strong> Evaluasi Sumatif, Kunci Jawaban, Standar Nilai & Rekap Excel (.xlsx).</span>
                </li>
            </ul>
        </div>
