...
<div class="bg-white border border-slate-200/80 rounded-3xl shadow-sm p-6 sm:p-8 mb-8">
    <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
        ...
        <div class="flex flex-wrap items-center gap-3 shrink-0">
            ...
            <button type="button"
                    @click="editModalOpen = true"
                    class="inline-flex items-center gap-2 px-5 py-2.5 text-xs sm:text-sm font-bold text-slate-700 bg-white border border-slate-200 hover:bg-blue-50 hover:text-blue-700 hover:border-blue-200 rounded-2xl transition-all shadow-sm"
                    title="Ubah Nama & Identitas Modul">
