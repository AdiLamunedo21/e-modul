...
<div class="max-w-2xl">
    ...
    <div class="mb-8">
        ...
        <p class="mt-1.5 text-sm text-slate-500">
            Langkah awal: tentukan judul dan target kelas. Setelah tersimpan sebagai <strong>Draft</strong>, Anda bisa mengisi konten Bagian Awal, mengaktifkan 7 komponen Bagian Inti, dan Bagian Akhir melalui halaman detail modul.
        </p>
    </div>
        ...
        <form action="{{ route('teacher.modules.store') }}" method="POST" class="space-y-6">
            ...
            <div class="rounded-xl bg-blue-50 border border-blue-100 p-4">
                ...
                <div class="space-y-1.5">
                    @foreach([
                        ['1', 'Bagian Awal (Mandatori)', 'Cover, Kata Pengantar, Peta Konsep, Glosarium, Tujuan Pembelajaran.'],
