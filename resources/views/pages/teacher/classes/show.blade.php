    ...
    <div class="bg-white rounded-3xl border border-slate-200/80 shadow-sm overflow-hidden">
        ...
        <div x-show="activeTab === 'modules'"
             ...
             x-data="{
                 ...
                 isModuleVisible(idx) {
                     const targetMod = this.modules[idx];
                     if (!targetMod) return false;
                     return this.paginatedModules.some(m => m.id === targetMod.id);
                 },
                 get totalVisible() {
            ...
            @else
                {{-- ═══ 3. FILTER & SEARCH BAR UNTUK MODUL DI KELAS INI ═══ --}}
                ...
                <div x-show="explorerView === 'grid'" class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
                    @foreach($teacherModules as $idx => $mod)
                        ...
                        @endphp
                        <div x-show="isModuleVisible({{ $idx }})"
