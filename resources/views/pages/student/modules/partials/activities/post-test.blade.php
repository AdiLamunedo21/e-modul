                        ...
                        <div class="pt-4 border-t border-rose-100 flex flex-col sm:flex-row items-center justify-between gap-3">
                            ...
                            <template x-if="nextPage">
                                <button type="button"
                                        ...
                                        class="w-full sm:w-auto px-8 py-3 rounded-2xl bg-rose-600 hover:bg-rose-700 text-white font-bold text-xs sm:text-sm shadow-md shadow-rose-600/25 transition flex items-center justify-center gap-2 cursor-pointer">
