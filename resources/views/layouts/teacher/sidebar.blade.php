    ...
    <div class="flex flex-col w-72 h-full">
        ...
        <nav class="flex-1 overflow-y-auto px-4 py-6 space-y-1">
            ...
            <a href="{{ route('dashboard.teacher') }}"
               class="flex items-center gap-3 rounded-xl px-3.5 py-2.5 text-sm font-semibold bg-blue-600 text-white shadow-lg shadow-blue-600/25 transition-all">
            ...
            {{-- Manajer Modul --}}
            <a href="#" class="flex items-center justify-between rounded-xl px-3.5 py-2.5 text-sm font-medium text-slate-400 hover:bg-slate-800 hover:text-white transition-colors group">
                <div class="flex items-center gap-3">
                    <svg class="w-5 h-5 shrink-0 group-hover:text-blue-400 transition-colors" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M12 6.042A8.967 8.967 0 006 3.75c-1.052 0-2.062.18-3 .512v14.25A8.987 8.987 0 016 18c2.305 0 4.408.867 6 2.292m0-14.25a8.966 8.966 0 016-2.292c1.052 0 2.062.18 3 .512v14.25A8.987 8.987 0 0018 18a8.967 8.967 0 00-6 2.292m0-14.25v14.25"/>
                    </svg>
                    <span>Manajer Modul</span>
                </div>
                <span class="text-[10px] font-semibold bg-slate-800 text-blue-400 px-2 py-0.5 rounded-full border border-slate-700">3 Aktif</span>
            </a>
            ...
            <a href="#" class="flex items-center justify-between rounded-xl px-3.5 py-2.5 text-sm font-medium text-slate-400 hover:bg-slate-800 hover:text-white transition-colors group">
                ...
                <span class="text-[10px] font-bold bg-amber-500/20 text-amber-300 border border-amber-500/30 px-2 py-0.5 rounded-full animate-pulse">18 Antrean</span>
            </a>
